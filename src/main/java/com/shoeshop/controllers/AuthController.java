...
public class AuthController extends JwtAuthenticationController {
	...
	public Map<String, ?> signin(@RequestBody UserOne user) throws Exception {
		...
		if (user1 != null) {
			...
			map.put("status", 200);
			map.put("responseData", responseDTO);
			return map;
		} else {
			map.put("status", 404);
			return null;
